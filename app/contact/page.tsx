...
// 7yedna l-import dyal { div } hit makinch o kider erour f build
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              {/* Zdtha lik hna hit konti m-importi Clock bach build idoz n9i */}
              <div className="flex items-start gap-4">
                <div className="p-3 bg-gray-50 rounded-lg">
                  <Clock size={24} className="text-black" />
                </div>
                <div>
                  <h3 className="font-bold text-black">Horaires</h3>
                  <p className="text-[#7b7b7b]">Lun - Ven: 09:00 - 18:30</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-8 md:p-10 rounded-2xl border border-gray-100">
            <form className="space-y-6">
              ...
              <button type="button" className="w-full bg-black text-white py-4 rounded-xl font-bold hover:bg-gray-800 transition-colors shadow-lg shadow-gray-200">
                Envoyer le message
              </button>
            </form>
          </div>
